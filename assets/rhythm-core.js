...
const PATTERN_DEFINITIONS = [
  ...
  {
    id: "eightThirtySeconds",
    label: "Eight thirty-second notes",
    name: "八个三十二分音符",
    symbol: "32x8",
    glyph: "eight-thirty-seconds",
    family: "division",
    color: "violet",
    unlockLevel: MASTER_UNLOCK_LEVEL,
    difficulty: 9,
    beats: 1,
    syllables: "TA-KA-TA-KA-DI-MI-TA-KA",
    description: "Eight equal thirty-second sounds inside one beat.",
    hits: [
      hit(0, "stick", 0.84, 0.04),
      hit(0.125, "wood", 0.72, 0.04),
      hit(0.25, "stick", 0.74, 0.04),
      hit(0.375, "wood", 0.72, 0.04),
      hit(0.5, "stick", 0.78, 0.04),
      hit(0.625, "wood", 0.72, 0.04),
      hit(0.75, "stick", 0.74, 0.04),
      hit(0.875, "wood", 0.78, 0.04),
    ],
  },
  {
    id: "fourThirtySecondsEighth",
    label: "Four thirty-second notes plus eighth",
    name: "前四个三十二分后八分",
    symbol: "32x4+8",
    glyph: "four-thirty-seconds-eighth",
    family: "division",
    color: "gold",
    unlockLevel: MASTER_UNLOCK_LEVEL,
    difficulty: 9,
    beats: 1,
    syllables: "TA-KA-DI-MI-TA",
    description: "Four thirty-second sounds followed by one eighth-note sound.",
    hits: [
      hit(0, "stick", 0.84, 0.04),
      hit(0.125, "wood", 0.72, 0.04),
      hit(0.25, "stick", 0.74, 0.04),
  ...
  {
    id: "eighthFourThirtySeconds",
    label: "Eighth plus four thirty-second notes",
    name: "前八分后四个三十二分",
    symbol: "8+32x4",
    glyph: "eighth-four-thirty-seconds",
    family: "division",
    color: "orange",
    unlockLevel: MASTER_UNLOCK_LEVEL,
    difficulty: 9,
    beats: 1,
    syllables: "TA-KA-DI-MI-NA",
    description: "One eighth-note sound followed by four thirty-second sounds.",
    hits: [
      hit(0, "stick", 0.84),
      hit(0.5, "wood", 0.78, 0.04),
      hit(0.625, "stick", 0.72, 0.04),
      hit(0.75, "wood", 0.74, 0.04),
      hit(0.875, "stick", 0.8, 0.04),
    ],
  },
];
